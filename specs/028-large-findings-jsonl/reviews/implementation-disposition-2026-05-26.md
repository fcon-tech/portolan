...
`/home/governor/projects/vibe_coding`: map rendering failed while reading a
...
- `verified`: `.portolan/bin/portolan map --root /home/governor/projects/vibe_coding --out /tmp/portolan-vibecoding-map-028 --force`
