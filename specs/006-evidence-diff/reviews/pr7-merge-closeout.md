...
- `specs/006-evidence-diff/spec.md`: status is `Implemented`.
- `specs/006-evidence-diff/tasks.md`: all implementation, review, verification,
  PR, and PR review tasks are checked.
- `specs/006-evidence-diff/reviews/`: status reconstruction,
