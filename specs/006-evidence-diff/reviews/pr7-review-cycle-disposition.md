...
- PR: `https://github.com/governor/portolan/pull/7`
...
- `jq empty schema/*.json internal/app/testdata/evidence-diff/base.json internal/app/testdata/evidence-diff/head.json testdata/evidence-diff/base.json testdata/evidence-diff/head.json`: passed.
