...
| --- | --- | --- | --- |
| README Quick Start lacked a clone path and newcomer install entry. | Opus, DeepSeek | accepted / fixed | Added `git clone https://github.com/governor/portolan.git`, `cd portolan`, `--help`, and Go prerequisite language to `README.md`; mirrored in `docs/ru/README.md`. |
