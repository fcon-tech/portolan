...
rsync -a --delete --exclude .git --exclude .portolan --exclude graphify-out \
  /home/governor/projects/sdp/portolan/ \
...
rsync -a --delete --exclude .git --exclude .portolan --exclude graphify-out \
  /home/governor/projects/sdp/portolan/ "$tmp_parent/portolan/"
...
target `/home/governor/projects/vibe_coding/spec-kit`, English install
...
Scope: OpenCode `1.15.10` with `kimi-for-coding/k2p6`, external single-repo
target `/home/governor/projects/vibe_coding/spec-kit`, Russian install
...
`/home/governor/projects/vibe_coding/spec-kit`, external `/tmp` output
...
Scope: OpenCode `1.15.10` with `kimi-for-coding/k2p6`, English install prompt
block from `docs/agent/INSTALL-PROMPT.md`, external single-repo target
`/home/governor/projects/vibe_coding/spec-kit`, repo-local output path
