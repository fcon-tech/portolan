...
- PR: https://github.com/governor/portolan/pull/15
...
| `specs/035-oss-producer-acceptance/spec.md` | Updated to `Merged with partial producer acceptance`. |
| `specs/035-oss-producer-acceptance/tasks.md` | All tasks remain checked. |
| `specs/035-oss-producer-acceptance/reviews/pr15-merge-approval-2026-05-27.md` | Records explicit user approval and model/process updates. |
| `specs/035-oss-producer-acceptance/reviews/review-lane-recovery-2026-05-27.md` | Records DeepSeek, OpenRouter MiniMax, and GLM as the restored slice-review set. |
