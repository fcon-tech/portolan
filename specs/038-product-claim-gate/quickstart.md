...
find specs/034-cursor-comparison-validation specs/035-oss-producer-acceptance specs/036-scope-completeness-validation specs/037-relationship-evidence-taxonomy -maxdepth 3 -type f | sort
```

## 2. Build The Claim Ledger

Create `specs/038-product-claim-gate/reviews/product-claim-ledger-YYYY-MM-DD.md`
...
Create `specs/038-product-claim-gate/reviews/client-safe-answer-YYYY-MM-DD.md`.
...
- review dispositions under `specs/038-product-claim-gate/reviews/`
