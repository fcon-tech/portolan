...
- Spec status: `specs/038-product-claim-gate/spec.md` is `Draft`.
...
`setup-plan.sh --json` selected `specs/034-cursor-comparison-validation/`
instead of `specs/038-product-claim-gate/` on branch
...
- `specs/036-scope-completeness-validation/reviews/`
