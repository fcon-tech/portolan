...
- Remote feature branch cleanup: requested by `gh pr merge --delete-branch`,
  ...
  out in `/home/governor/projects/sdp/portolan`. Remote branch cleanup was
...
- `specs/038-product-claim-gate/spec.md`: updated to "Implemented and merged
  via PR #18; GitHub checks not_assessed".
- `specs/038-product-claim-gate/tasks.md`: all implementation, review, and PR
  readiness tasks were already checked before merge.
- Review artifacts remain spec-local under
  `specs/038-product-claim-gate/reviews/`.
