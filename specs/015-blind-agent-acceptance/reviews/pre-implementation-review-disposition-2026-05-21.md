...
- `specs/015-blind-agent-acceptance/spec.md`
- `specs/015-blind-agent-acceptance/plan.md`
- `specs/015-blind-agent-acceptance/tasks.md`
...
`specs/015-blind-agent-acceptance/templates/run-ledger.md` and keep run evidence
under `specs/015-blind-agent-acceptance/reviews/`.
...
`testdata/map-command/repo` fixture is suitable for command preflight, but a
