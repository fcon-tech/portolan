...
- Target root:
  `/Users/governor/.codex/worktrees/9198/portolan/testdata/map-command/repo`
...
| --- | --- | --- |
| `go run ./cmd/portolan map --root testdata/map-command/repo --out /tmp/portolan-015-control-preflight --force` | verified | wrote map bundle |
