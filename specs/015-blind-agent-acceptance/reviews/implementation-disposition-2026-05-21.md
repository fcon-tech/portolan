...
- added `docs/agent-toolbox/blind-acceptance.md` with the allowed prompt,
  ...
  review procedure;
- added `specs/015-blind-agent-acceptance/templates/run-ledger.md`;
- added spec-local review evidence home under
  `specs/015-blind-agent-acceptance/reviews/`;
...
`specs/015-blind-agent-acceptance/reviews/pre-implementation-review-disposition-2026-05-21.md`
were fixed:
