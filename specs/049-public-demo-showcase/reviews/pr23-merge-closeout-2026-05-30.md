...
```bash
go test -count=1 ./...
jq empty .specify/feature.json schema/*.json examples/public-demo/bigtop/*.json
git diff --check
```
...
- `specs/049-public-demo-showcase/spec.md`: implemented and merged via PR #23.
- `docs/product-backlog.md`: P5-049 implemented and merged via PR #23.
- `specs/049-public-demo-showcase/tasks.md`: all tasks complete.
