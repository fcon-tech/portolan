...
- top-level redaction policy in `examples/public-demo/README.md`;
- redacted Bigtop excerpts under `examples/public-demo/bigtop/`;
...
| `jq empty .specify/feature.json schema/*.json examples/public-demo/bigtop/*.json` | verified | Passed. |
