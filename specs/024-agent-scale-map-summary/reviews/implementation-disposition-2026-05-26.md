...
Implemented `specs/024-agent-scale-map-summary/` to address blind acceptance
gaps:
...
| Bigtop smoke | verified | `go run ./cmd/portolan map --root /home/governor/projects/bigtop-landscape --out /tmp/portolan-024-bigtop-summary --force` passed. |
...
| Control smoke | verified | `go run ./cmd/portolan map --root /home/governor/projects/consensus_tg_bot --out /tmp/portolan-024-control-summary --force` passed. |
