...
```bash
/home/governor/projects/sdp/portolan/.portolan/bin/portolan context prepare \
  --root /home/governor/projects/bigtop-landscape \
  --out /tmp/portolan-opencode-install-bigtop-r5W09x/context \
  --profile cursor
```

- Discovered `/home/governor/projects/bigtop-landscape/selection.json`.
- Built the map with:

```bash
/home/governor/projects/sdp/portolan/.portolan/bin/portolan map \
  --selection /home/governor/projects/bigtop-landscape/selection.json \
