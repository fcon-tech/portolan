...
TARGET_PATH=/home/governor/projects/vibe_coding/spec-kit
...
opencode run --model kimi-for-coding/k2p6 --dangerously-skip-permissions \
  --format json --dir /home/governor/projects/sdp/portolan \
...
```bash
cd /home/governor/projects/sdp/portolan && ./scripts/bootstrap-portolan
```

- Verified the repo-local binary:

```bash
cd /home/governor/projects/sdp/portolan && .portolan/bin/portolan --version
```

- Prepared context with:

```bash
cd /home/governor/projects/sdp/portolan && .portolan/bin/portolan context prepare \
  --root /home/governor/projects/vibe_coding/spec-kit \
...
```bash
cd /home/governor/projects/sdp/portolan && .portolan/bin/portolan map \
  --root /home/governor/projects/vibe_coding/spec-kit \
