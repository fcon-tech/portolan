...
```text
You are working in /home/governor/projects/sdp/portolan.
...
- read specs/047-canonical-public-install-release/reviews/;
- read specs/048-github-community-discovery/reviews/openssf-best-practices-self-assessment-2026-05-31.md.
...
5. Record release closeout under
   specs/047-canonical-public-install-release/reviews/ with:
   - release commit;
   - tag;
   - GitHub release URL;
   - local checks;
