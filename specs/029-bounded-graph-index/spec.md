...
**Input**: Product validation on `/home/governor/projects/vibe_coding`
...
- **FR-006**: Product hypothesis ledgers MUST record whether the real
  `/home/governor/projects/vibe_coding` run produces an agent-sized graph
  index.
...
- **SC-002**: A focused test verifies the index has bounded samples and graph
  artifact sizes.
- **SC-003**: A real `/home/governor/projects/vibe_coding` map run produces
