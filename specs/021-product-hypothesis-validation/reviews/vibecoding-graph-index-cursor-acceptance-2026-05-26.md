...
`specs/029-bounded-graph-index/` adds `graph-index.json` with:
...
```bash
.portolan/bin/portolan map --root /home/governor/projects/vibe_coding --out /tmp/portolan-vibecoding-map-029 --force
```
