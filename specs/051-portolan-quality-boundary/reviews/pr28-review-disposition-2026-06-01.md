...
- `go run ./cmd/portolan report quality --summary testdata/report-quality/thin-honest.json`: verified pass verdict
- `go run ./cmd/portolan report quality --summary testdata/report-quality/hidden-weak-state.json`: verified fail verdict
