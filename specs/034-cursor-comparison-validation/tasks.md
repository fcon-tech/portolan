...
- [x] T002 Record fixed-target preconditions in `specs/034-cursor-comparison-validation/reviews/preconditions-2026-05-26.md` using `test -d /home/governor/projects/bigtop-landscape` and readable-path checks.
