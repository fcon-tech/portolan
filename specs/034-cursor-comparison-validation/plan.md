...
**Spec**: `specs/034-cursor-comparison-validation/spec.md`

**Input**: Feature specification from
`specs/034-cursor-comparison-validation/spec.md`
...
**Storage**: Spec-local files under `specs/034-cursor-comparison-validation/`;
...
local `/home/governor/projects/bigtop-landscape`, and optional Cursor Agent
CLI/UI surface.
