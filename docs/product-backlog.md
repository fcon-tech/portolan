...
| P5-048 | `specs/048-github-community-discovery/` | Public GitHub visitors and contributors can understand Portolan, find contribution/security routes, and see honest OSS-health states. | Ready-for-review PR #24; GitHub description/topics/homepage, private vulnerability reporting, local verification, three non-GPT review lanes, and GitHub checks verified; remaining blockers: merge approval not_assessed, review approval not_assessed, default-branch community profile blocked until merge and recheck |
