...
| P6-066 | `docs/specs/066-bigtop-protobuf-api-descriptors/` | Real Bigtop protobuf API descriptor outputs are generated with `protoc` for bounded Hadoop/HBase surfaces, while upstream duplicate/generated-import blockers remain explicit. | Ready-for-review PR candidate; `protoc` generated descriptor sets for Hadoop HDFS/common, Hadoop YARN API/common, and HBase REST, Cursor Composer 2.5 preserved descriptor outputs as metadata-visible API/catalog evidence only, three assessed non-GPT review lanes completed, local baseline passed; whole-Hadoop and HBase shaded descriptors remain blocked, runtime topology and full def/ref/call graph remain `cannot_verify` |
