...
| P3-029 | future | Bounded graph and map artifact budgets so agents can request slices instead of handling hundreds of megabytes of raw graph output. | Idea from `/home/governor/projects/vibe_coding` validation |
