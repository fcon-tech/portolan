...
| P5-049 | `specs/049-public-demo-showcase/` | Public evaluators can run a reproducible Apache Bigtop demo and read a claim-bounded case study without leaking private context or hiding unknowns. | Implemented locally; public runbook, redacted excerpts, local cold-start and existing-landscape smoke evidence, claim scan, privacy/freshness review, and baseline checks verified; PR review pending |
