...
| P6-071 | `docs/specs/071-bigtop-ctags-cross-language-imports/` | Universal Ctags cross-language reference roles are extracted for selected Bigtop C/C++ headers, Python imports/namespaces, and shell loaded scripts to close part of the excluded-language gap left by spec 070. | Local implementation complete; Universal Ctags 6.2.1 produced 147,472 C/C++/Python/Sh reference-role records across 8,432 files, Cursor stress and three assessed non-GPT review lanes preserved full C6 boundaries, and local baseline passed; full symbol/reference graph, call graph, runtime topology, and enterprise parity remain `cannot_verify`; PR state pending |
