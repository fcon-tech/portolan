...
| P6-070 | `docs/specs/070-bigtop-ctags-import-references/` | Universal Ctags import-reference roles are extracted for the selected Bigtop scope to move C6 from definitions-only evidence to bounded source-visible import-reference evidence without installing new indexers or mutating target repositories. | Local implementation complete; Universal Ctags 6.2.1 produced 873,435 Java/Go package import-reference records across 59,704 files, Cursor stress and three assessed non-GPT review lanes preserved full C6 boundaries, and local baseline passed; full symbol/reference graph, call graph, runtime topology, and enterprise parity remain `cannot_verify`; PR state pending |
