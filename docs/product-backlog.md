...
| P6-060 | `docs/specs/060-bigtop-runtime-topology-acquisition/` | Runtime-visible Bigtop topology evidence is acquired from existing local Docker/Kubernetes/process surfaces if present, or the absence of a safe Bigtop runtime export is proven with explicit local evidence. | Planning in progress; read-only Docker, Kubernetes, process, and selection probes under review |
