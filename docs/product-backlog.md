...
| P5-045 | `specs/045-docs-harness-onboarding/` | Humans and agents can choose the right Portolan documentation route for overview, install/build, Cursor, OpenCode, release, and SpecKit work without reading review ledgers first. | Implemented locally; PR review and GitHub checks not_assessed |
