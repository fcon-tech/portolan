...
**Input**: Design documents from `docs/specs/043-readonly-query-surface/`

**Tests**: Required for CLI behavior and output contracts.

## Phase 1: Setup

- [x] T001 Create pre-implementation review in `docs/specs/043-readonly-query-surface/reviews/requirements-product-vision-drift-2026-05-27.md`
- [x] T002 Record analyze disposition in `docs/specs/043-readonly-query-surface/reviews/analyze-disposition-2026-05-27.md`
