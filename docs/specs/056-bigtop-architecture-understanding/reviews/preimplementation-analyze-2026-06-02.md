...
| Bigtop producer ledger | `/home/governor/projects/bigtop-landscape/.portolan/producer-runs.jsonl` includes deployment-model and bounded API/catalog evidence plus explicit runtime and symbol `not_assessed` records. |
