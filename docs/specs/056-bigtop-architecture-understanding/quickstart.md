...
2. Confirm Bigtop evidence inputs:
   ...
   ```bash
   sed -n '1,120p' /home/governor/projects/bigtop-landscape/.portolan/producer-runs.jsonl
   sed -n '1,160p' /home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/context/agent-brief.md
   ```
