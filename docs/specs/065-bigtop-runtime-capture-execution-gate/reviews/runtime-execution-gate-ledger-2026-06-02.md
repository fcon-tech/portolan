...
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-065-runtime-execution-gate/tool-outputs`
...
- `/home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo/provisioner/docker/docker-hadoop.sh`
  exists.
- `/home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo/provisioner/docker/docker-compose.yml`
  exists.
- `/home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo/provisioner/docker/docker-compose-cgroupv2.yml`
  exists.
...
```bash
cd /home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo/provisioner/docker
