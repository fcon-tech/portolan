...
- `verified`: `go run ./cmd/portolan adapter validate --in internal/testfixtures/oss-adapter-contract/jscpd.json`
- `verified`: `go run ./cmd/portolan adapter validate --in internal/testfixtures/oss-adapter-contract/syft-cyclonedx.json`
- `verified`: `go run ./cmd/portolan adapter validate --in internal/testfixtures/oss-adapter-contract/semgrep.json`
