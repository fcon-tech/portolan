...
## Decision: Use `/home/governor/projects/bigtop-landscape` As The Fixed Target
...
- `/home/governor/projects/vibe_coding`: real 30-repo local landscape, but
  not selected during clarification.
- `internal/testfixtures/landscape-map`: more repeatable, but too fixture-like for the core
  product claim.
