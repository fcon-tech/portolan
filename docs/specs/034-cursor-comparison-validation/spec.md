...
- Q: What fixed comparison target should spec 034 require for both Cursor-alone and Cursor-plus-Portolan lanes? → A: `/home/governor/projects/bigtop-landscape`
...
- **FR-007**: The fixed comparison target MUST be
  `/home/governor/projects/bigtop-landscape`; results MUST distinguish
