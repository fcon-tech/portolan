...
- Target path: `/home/governor/projects/bigtop-landscape`
...
```json
{
  ...
  "run_state": "completed",
  "prompt_path": "docs/specs/034-cursor-comparison-validation/reviews/cursor-alone-prompt.md",
  "raw_output_path": "docs/specs/034-cursor-comparison-validation/reviews/cursor-alone-output.md",
  "input_artifacts": [],
  "failure_reason": ""
}
```
...
```json
{
  ...
  "run_state": "completed",
  "prompt_path": "docs/specs/034-cursor-comparison-validation/reviews/cursor-plus-portolan-prompt.md",
  "raw_output_path": "docs/specs/034-cursor-comparison-validation/reviews/cursor-plus-portolan-output.md",
  "input_artifacts": [
...
- Cursor-alone prompt:
  `docs/specs/034-cursor-comparison-validation/reviews/cursor-alone-prompt.md`
- Cursor-alone raw output:
  `docs/specs/034-cursor-comparison-validation/reviews/cursor-alone-output.md`
- Cursor-plus-Portolan prompt:
  `docs/specs/034-cursor-comparison-validation/reviews/cursor-plus-portolan-prompt.md`
- Cursor-plus-Portolan raw output:
  `docs/specs/034-cursor-comparison-validation/reviews/cursor-plus-portolan-output.md`
