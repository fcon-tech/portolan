...
- Preconditions:
  `docs/specs/034-cursor-comparison-validation/reviews/preconditions-2026-05-26.md`
- CLI surface:
  `docs/specs/034-cursor-comparison-validation/reviews/cli-surface-2026-05-26.md`
- Portolan artifacts:
  `docs/specs/034-cursor-comparison-validation/reviews/portolan-artifacts-2026-05-26.md`
- Cursor-alone output:
...
- Verification:
  `docs/specs/034-cursor-comparison-validation/reviews/verification-2026-05-26.md`
