...
| --- | --- | --- |
| PR | verified | GitHub PR #9: `https://github.com/governor/portolan/pull/9`. |
...
| `go run ./cmd/portolan map --root internal/testfixtures/map-command/repo --out /tmp/portolan-map-run --force` | verified |
