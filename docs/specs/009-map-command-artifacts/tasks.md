...
**Input**: Design documents from `docs/specs/009-map-command-artifacts/`
...
- [x] T001 [P] Add fixture repository under `internal/testfixtures/map-command/repo/`.
- [x] T002 [P] [US1] Add failing tests for `portolan map --root internal/testfixtures/map-command/repo --out <dir> --force` in `internal/app/app_test.go`.
...
- [x] T015 Update `docs/product-backlog.md` and `docs/specs/009-map-command-artifacts/spec.md` status after implementation.
- [x] T016 Record review disposition under `docs/specs/009-map-command-artifacts/reviews/`.
- [x] T017 Run `go test ./...`.
- [x] T018 Run `jq empty schema/*.json internal/testfixtures/corpus-manifests/apache-bigtop/manifest.json`.
- [x] T019 Run `go run ./cmd/portolan map --root internal/testfixtures/map-command/repo --out /tmp/portolan-map-run --force`.
