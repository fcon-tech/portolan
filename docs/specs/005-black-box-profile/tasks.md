...
**Input**: Design documents from `docs/specs/005-black-box-profile/`
...
- [x] T001 [P] Add black-box profile fixtures in `internal/testfixtures/black-box-profile/selection.json`, `internal/testfixtures/black-box-profile/missing-dependency-selection.json`, `internal/testfixtures/black-box-profile/malformed-runtime-selection.json`, `internal/testfixtures/black-box-profile/metadata/payments.json`, `internal/testfixtures/black-box-profile/runtime/payments.json`, `internal/testfixtures/black-box-profile/runtime/malformed.json`, and `internal/testfixtures/black-box-profile/claims/payments.json`.
- [x] T002 [P] [US1] Add failing CLI scan test for `portolan scan --selection internal/testfixtures/black-box-profile/selection.json --out <file> --force` in `internal/app/app_test.go`.
...
- [x] T020 Update `docs/product-backlog.md` and `docs/specs/005-black-box-profile/spec.md` status after implementation.
- [x] T021 Record pre-implementation review disposition under `docs/specs/005-black-box-profile/reviews/`.
- [x] T022 Record post-slice review disposition under `docs/specs/005-black-box-profile/reviews/`.
- [x] T023 Run `go test -count=1 ./...`.
- [x] T024 Run `jq empty schema/*.json`.
- [x] T025 Run `go run ./cmd/portolan scan --selection internal/testfixtures/black-box-profile/selection.json --out /tmp/portolan-black-box-graph.json --force`.
