...
All tasks are complete in `docs/specs/003-human-readable-packet/tasks.md`.
...
- `docs/specs/003-human-readable-packet/spec.md`: status is `Implemented in branch`.
- `tasks.md`: all tasks are checked.
- Review artifacts are under `docs/specs/003-human-readable-packet/reviews/`.
...
- PR exists at https://github.com/governor/portolan/pull/4.
