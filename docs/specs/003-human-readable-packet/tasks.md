...
**Input**: Design documents from `docs/specs/003-human-readable-packet/`
...
- [x] T001 [P] Add packet graph fixtures in `internal/testfixtures/human-readable-packet/graph.json`, `internal/testfixtures/human-readable-packet/claim-only-graph.json`, and `internal/testfixtures/human-readable-packet/malformed-graph.json`.
...
- [x] T014 Record pre-implementation review disposition under `docs/specs/003-human-readable-packet/reviews/`.
- [x] T015 Record post-slice review disposition under `docs/specs/003-human-readable-packet/reviews/`.
- [x] T016 Update `docs/product-backlog.md` and `docs/specs/003-human-readable-packet/spec.md` status after implementation.
- [x] T017 Run `go test -count=1 ./...`.
- [x] T018 Run `jq empty schema/*.json`.
- [x] T019 Run `go run ./cmd/portolan packet render --graph internal/testfixtures/human-readable-packet/graph.json --out /tmp/portolan-packet.md --force`.
