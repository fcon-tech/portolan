...
go run ./cmd/portolan context prepare \
  ...
  --out /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-082-syft-sharded-sbom-plan/context \
  --profile cursor \
  --force
```
...
- Context pack was written under:
  `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-082-syft-sharded-sbom-plan/context`
...
- Every Syft command reads exactly one repository path and writes under:
  `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-082-syft-sharded-sbom-plan/context/tool-outputs/syft/`
