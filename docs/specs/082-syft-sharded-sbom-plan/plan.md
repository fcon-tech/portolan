...
git diff --check
go run ./cmd/portolan context prepare --root /home/governor/projects/bigtop-landscape --out /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-082-syft-sharded-sbom-plan/context --profile cursor --force
```
