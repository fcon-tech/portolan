...
```text
Portolan: /home/governor/projects/sdp/portolan
...
| GAP-NO-BINARY | No `portolan` binary on PATH. | Cursor Agent used `/home/governor/go/bin/go run`. | Add packaging/install slice. |
