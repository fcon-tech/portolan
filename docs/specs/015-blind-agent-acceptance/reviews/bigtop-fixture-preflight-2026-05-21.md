...
- Portolan path: `/Users/governor/.codex/worktrees/9198/portolan`
- Target root:
  `/Users/governor/.codex/worktrees/9198/portolan/internal/testfixtures/apache-bigtop-smoke/repo`
...
| --- | --- | --- |
| `go run ./cmd/portolan map --root internal/testfixtures/apache-bigtop-smoke/repo --out /tmp/portolan-015-bigtop-preflight --force` | verified | wrote map bundle |
...
| --- | --- | --- | --- |
| GAP-015-003 | Real Bigtop operator lane remains unassessed until a local Bigtop checkout is mapped through the blind prompt. | This run used `internal/testfixtures/apache-bigtop-smoke/repo`, not a real checkout and not an external agent transcript. | Run the blind protocol against a real local Bigtop checkout. |
