...
```bash
cursor-agent --print --mode ask --trust --model composer-2.5 --workspace /home/governor/projects/sdp/portolan "$(cat docs/specs/055-runtime-topology-evidence/reviews/cursor-runtime-stress-prompt-2026-06-02.md)" > docs/specs/055-runtime-topology-evidence/reviews/cursor-runtime-stress-output-2026-06-02.md
```
...
| C3 | Cursor classified Bigtop runtime topology as `not_assessed` / not verified because `/home/governor/projects/bigtop-landscape/selection.json` has `"runtime": null` and the producer-run ledger records `producer-run-bigtop-runtime-not-assessed-20260601`. | Accepted; no overclaim found. |
