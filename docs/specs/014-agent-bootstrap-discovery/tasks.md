...
**Input**: `docs/specs/014-agent-bootstrap-discovery/spec.md`
**Prerequisites**: `docs/specs/014-agent-bootstrap-discovery/plan.md`

## Phase 1: Contract Review

- [x] T001 Review `agent/AGENT_GUIDE.md`, `README.md`,
  `docs/agent-toolbox/README.md`, and `docs/agent/cursor-rules/portolan-map.mdc` for
  hidden Cursor or Bigtop assumptions.
- [x] T002 Record pre-implementation findings under
  `docs/specs/014-agent-bootstrap-discovery/reviews/`.
...
- [x] T007 Ensure the portable skill defines the same minimum inputs, map
  ...
  the root entrypoint.
- [x] T008 Update `docs/agent/cursor-rules/portolan-map.mdc` so it delegates to the
