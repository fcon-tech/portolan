...
- updated `docs/agent/cursor-rules/portolan-map.mdc` to delegate to `START_HERE` and
...
`docs/specs/014-agent-bootstrap-discovery/reviews/pre-implementation-review-disposition-2026-05-21.md`
were fixed:
