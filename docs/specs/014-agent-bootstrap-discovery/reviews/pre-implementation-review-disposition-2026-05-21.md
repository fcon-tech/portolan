...
- `docs/specs/014-agent-bootstrap-discovery/spec.md`
- `docs/specs/014-agent-bootstrap-discovery/plan.md`
- `docs/specs/014-agent-bootstrap-discovery/tasks.md`
...
`docs/agent/cursor-rules/portolan-map.mdc` tells agents to try `portolan doctor`, while
