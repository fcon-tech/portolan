...
**Date**: 2026-05-20
**Spec**: `docs/specs/008-agent-skill-pack/`
**Mode**: IMPLEMENT
...
- `docs/specs/008-agent-skill-pack/spec.md`
- `docs/specs/008-agent-skill-pack/tasks.md`
...
| Cursor rule delegates to portable guide | fixed | `docs/agent/cursor-rules/portolan-map.mdc` |
...
| Spec/backlog/task status surfaces agree | fixed | `docs/product-backlog.md`, `docs/specs/008-agent-skill-pack/spec.md`, `docs/specs/008-agent-skill-pack/tasks.md` |
...
| `go test ./...` | verified |
| `jq empty schema/*.json internal/testfixtures/corpus-manifests/apache-bigtop/manifest.json` | verified |
