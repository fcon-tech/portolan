...
**Input**: Design documents from `docs/specs/008-agent-skill-pack/`
...
- [x] T002 [US2] Add Cursor rule at `docs/agent/cursor-rules/portolan-map.mdc` that delegates to `agent/AGENT_GUIDE.md`.
...
- [x] T005 [US2] Verify `docs/agent/cursor-rules/portolan-map.mdc` does not describe Portolan as Cursor-only.
...
- [x] T008 Update `docs/product-backlog.md` and `docs/specs/008-agent-skill-pack/spec.md` status after implementation.
- [x] T009 Record review disposition under `docs/specs/008-agent-skill-pack/reviews/`.
- [x] T010 Run `go test ./...`.
- [x] T011 Run `jq empty schema/*.json internal/testfixtures/corpus-manifests/apache-bigtop/manifest.json`.
