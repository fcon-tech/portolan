...
1. **Given** `docs/agent/cursor-rules/portolan-map.mdc` exists, **When** a Cursor agent is
...
- **SC-002**: The Cursor rule is under `docs/agent/cursor-rules/` and references the
  portable guide.
...
- `portolan map` is specified in `docs/specs/009-map-command-artifacts/`; this slice
