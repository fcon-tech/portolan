...
go run ./cmd/portolan context prepare \
  --root /home/governor/projects/bigtop-landscape \
  --out /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context \
  --profile cursor \
  --force
```
...
- Exact stale producer output strings from
  ...
  context pack.
- Top-level `/home/governor/projects/bigtop-landscape/run` is absent.
...
rg -n "Fresh Artifact Boundary|Current context output|Ignore sibling|contaminated|current context boundary|stale sibling" \
  /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context
jq empty \
  /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/repos.json \
  /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/tool-registry.json \
  /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/oss-plan.json \
  /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/gaps.jsonl
...
rg -n 'Local producer run records' \
  /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/agent-brief.md
```
