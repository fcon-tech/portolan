...
- local source files under `/home/governor/projects/bigtop-landscape/repos/`
  only if the fresh context explicitly points you there.

Forbidden inputs:

- any sibling `/home/governor/projects/bigtop-landscape/.portolan/stress/*`
  directory other than `20260602-080-clean-start-artifact-guard`;
- `/home/governor/projects/bigtop-landscape/run`;
