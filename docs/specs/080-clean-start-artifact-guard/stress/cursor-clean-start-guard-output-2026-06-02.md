...
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context`
...
1. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/agent-brief.md`
2. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/answer-contract.md`
3. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/query-plan.md`
4. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/repos.json`
5. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/oss-plan.json`
6. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/tool-registry.json`
7. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/gaps.jsonl`
8. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/evidence-index.jsonl`
...
No reads were performed under sibling stress roots (e.g. `20260601-054-initial-proof`), `/home/governor/projects/bigtop-landscape/run`, root-level `.portolan/producer-runs.jsonl`, or map bundles outside the fresh context.
...
`/home/governor/projects/bigtop-landscape/.portolan/producer-runs.jsonl`, with **three** `verified` / `metadata-visible` runs whose `path` and `output_path` point at a **sibling** stress root:
