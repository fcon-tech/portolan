...
`agent-brief.md`, `answer-contract.md`, and `query-plan.md` define a **Fresh Artifact Boundary**: treat only this context directory and output paths declared inside it as current Portolan evidence. Target root is `/home/governor/projects/bigtop-landscape` (landscape scope), profile **Cursor**.
...
4. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/gaps.jsonl`
5. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/evidence-index.jsonl`
6. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/repos.json`
7. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/tool-registry.json`
8. `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-080-clean-start-artifact-guard/context/oss-plan.json`
