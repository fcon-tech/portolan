...
$ ls /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/ | head -20
AGENTS.md
CODE_OF_CONDUCT.md
CONTRIBUTING.md
LICENSE
...
$ du -sh /home/governor/projects/vibe_coding/spec-kit 2>/dev/null || echo "Target path not found"
9.2M	/home/governor/projects/vibe_coding/spec-kit

$ scripts/bootstrap-portolan
wrote /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/bin/portolan

$ mkdir -p /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/{context,map}
(no output)

$ .portolan/bin/portolan context prepare --root /home/governor/projects/vibe_coding/spec-kit --out /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context --profile cursor
context prepare: output path already exists; use --force to overwrite

$ .portolan/bin/portolan map --root /home/governor/projects/vibe_coding/spec-kit --out /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map
map: output path already exists; use --force to overwrite

$ ls -la /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context/
total 8
drwx------ 2 governor governor 4096 Jun  1 14:46 .
drwx------ 4 governor governor 4096 Jun  1 14:46 ..

$ ls -la /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map/
total 8
drwx------ 2 governor governor 4096 Jun  1 14:46 .
drwx------ 4 governor governor 4096 Jun  1 14:46 ..

$ .portolan/bin/portolan context prepare --root /home/governor/projects/vibe_coding/spec-kit --out /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context --profile cursor --force
wrote context pack /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context

$ .portolan/bin/portolan map --root /home/governor/projects/vibe_coding/spec-kit --out /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map --force
wrote map bundle /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map

$ ls -la /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context/
total 48
drwx------ 2 governor governor 4096 Jun  1 14:46 .
drwx------ 4 governor governor 4096 Jun  1 14:46 ..
-rw------- 1 governor governor 1413 Jun  1 14:46 agent-brief.md
-rw------- 1 governor governor 6693 Jun  1 14:46 answer-contract.md
-rw------- 1 governor governor 3524 Jun  1 14:46 evidence-index.jsonl
-rw------- 1 governor governor 1734 Jun  1 14:46 gaps.jsonl
-rw------- 1 governor governor 5146 Jun  1 14:46 oss-plan.json
-rw------- 1 governor governor 1589 Jun  1 14:46 query-plan.md
-rw------- 1 governor governor  375 Jun  1 14:46 repos.json
-rw------- 1 governor governor  184 Jun  1 14:46 tool-registry.json

$ ls -la /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map/
total 180
drwx------ 2 governor governor   4096 Jun  1 14:46 .
drwx------ 4 governor governor   4096 Jun  1 14:46 ..
-rw------- 1 governor governor   1171 Jun  1 14:46 coverage.json
-rw------- 1 governor governor   6723 Jun  1 14:46 findings.jsonl
-rw------- 1 governor governor  34438 Jun  1 14:46 graph-index.json
-rw------- 1 governor governor 105878 Jun  1 14:46 graph.json
-rw------- 1 governor governor   7885 Jun  1 14:46 map.md
-rw------- 1 governor governor   2332 Jun  1 14:46 run.json
-rw------- 1 governor governor   4266 Jun  1 14:46 summary.json
...
**Visible scope:**
- **1 repository**: `root` at `/home/governor/projects/vibe_coding/spec-kit` (source-visible) [repos.json:1-14]
...
1. **Run the available OSS producers** to close the largest evidence gaps:
   ...
   /home/linuxbrew/.linuxbrew/bin/syft /home/governor/projects/vibe_coding/spec-kit -o cyclonedx-json=/home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context/tool-outputs/syft.cyclonedx.json
   
   # jscpd for duplication detection
   /home/linuxbrew/.linuxbrew/bin/jscpd --reporters json --output /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context/tool-outputs --max-size 100kb --max-lines 1000 --ignore '**/.git/**,**/.portolan/**,**/node_modules/**,**/vendor/**,**/build/**,**/dist/**,**/target/**,**/generated/**' --noSymlinks --gitignore --silent /home/governor/projects/vibe_coding/spec-kit
   ```
   Then refresh context: `.portolan/bin/portolan context prepare --root /home/governor/projects/vibe_coding/spec-kit --out /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/context --profile cursor --force` [oss-plan.json:24-91]

2. **Investigate the 11 unresolved findings** by drilling into the graph:
   ```bash
   .portolan/bin/portolan query findings --bundle /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map --limit 20
   .portolan/bin/portolan query gaps --bundle /home/governor/projects/sdp/portolan-051-portolan-quality-boundary/.portolan/acceptance/051-full-blind-opencode-spec-kit/map --limit 20
   ```
