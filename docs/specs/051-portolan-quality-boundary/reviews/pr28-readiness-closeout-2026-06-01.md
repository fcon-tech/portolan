...
- Product narrative cleanup: README, demo, release, and product-claims routes
  now treat Apache Bigtop as a named stress example, not the main product
  story.
- Testdata cleanup: root and package-local testdata directories now have an
  explicit fixture contract; Apache Bigtop fixtures are documented as named
  stress/negative/corpus references only.
- Adjacent spec scope: `docs/specs/052-agent-scan-report-ux/` was pruned from the
...
| `go run ./cmd/portolan report quality --summary internal/testfixtures/report-quality/thin-honest.json` | verified |
...
- Bigtop harness stress: `bigtop-harness-stress-2026-06-01.md` records the
  ...
  `/home/governor/projects/bigtop-landscape/` under the revised harness
