...
| CRAP < 5 | verified after correction | `gocyclo` was available at `/home/governor/go/bin/gocyclo` outside `PATH`. After refactoring the new report-quality code path, the highest computed CRAP among new/changed report-quality functions is 4.84. |
...
- `/home/governor/go/bin/gocyclo internal/reportquality internal/app`: verified, used for CRAP calculation
