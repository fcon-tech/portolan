...
- `verified`: `go run ./cmd/portolan adapter validate --in internal/testfixtures/oss-adapter-contract/graphify-minimal.json`
...
- `verified`: `go run ./cmd/portolan selection validate --selection internal/app/testfixtures/runtime-security-boundary/selection.json`
- `verified`: `go run ./cmd/portolan scan --selection internal/app/testfixtures/runtime-security-boundary/selection.json --out /tmp/portolan-runtime-smoke-graph.json --force`
- `verified`: `go run ./cmd/portolan map --selection internal/app/testfixtures/runtime-security-boundary/selection.json --out /tmp/portolan-runtime-smoke --force`
