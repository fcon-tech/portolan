...
| --- | --- | --- |
| OpenCode multi-repo lane | `verified` narrowly | `docs/specs/041-agent-acceptance-matrix/reviews/opencode-k2p6-multi-repo-bigtop-lane-2026-05-27.md` records OpenCode + `kimi-for-coding/k2p6` against `/home/governor/projects/bigtop-landscape`, with context/map artifacts and preserved weak states. |
