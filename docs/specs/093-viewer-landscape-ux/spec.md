...
**Out of scope**: sdp_lab or any external scout runtime, LLM Q&A, full `portolan map` graph import (spec 094).
...
- **FR-001**: Product UI and CLI use **Portolan** naming only.
...
- **FR-007**: Entry point is `portolan-scan.sh` (no legacy misnamed scripts).
