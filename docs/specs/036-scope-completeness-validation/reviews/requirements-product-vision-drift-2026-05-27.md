...
- PR: https://github.com/governor/portolan/pull/16
- Reviewed surfaces:
  - `AGENTS.md`
  ...
  - `docs/specs/036-scope-completeness-validation/{spec.md,plan.md,tasks.md}`
  - `docs/specs/036-scope-completeness-validation/reviews/*.md`
