...
| Producer evidence | `verified` with explicit gaps | Syft produced a CycloneDX 1.6 SBOM for `/home/governor/projects/bigtop-landscape` with 18,769 components and 5,357 dependency records; `context prepare --force` preserved and normalized that output. |
