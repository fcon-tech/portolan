...
**Input**: Design documents from `docs/specs/035-oss-producer-acceptance/`
...
- [x] T001 Create `docs/specs/035-oss-producer-acceptance/reviews/` for evidence and dispositions.
- [x] T002 Record fixed-target preconditions for `/home/governor/projects/bigtop-landscape`.
