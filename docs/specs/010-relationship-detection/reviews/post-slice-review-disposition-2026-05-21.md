...
| `go run ./cmd/portolan map --root internal/testfixtures/relationship-detection/repo --out /tmp/portolan-relationships-run --force` | verified |
...
| `go run ./cmd/portolan scan --selection internal/testfixtures/relationship-detection/selection.json --out /tmp/portolan-relationship-selection-graph.json --force` | verified |
