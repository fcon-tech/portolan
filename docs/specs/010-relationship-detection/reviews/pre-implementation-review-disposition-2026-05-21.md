...
- `docs/specs/007-apache-bigtop-corpus/reviews/acceptance-smoke-ledger-2026-05-20.md`
...
| `jq empty schema/*.json internal/testfixtures/corpus-manifests/apache-bigtop/manifest.json` | verified | Passed after planning-only edits. |
