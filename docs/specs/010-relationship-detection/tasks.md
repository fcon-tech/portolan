...
**Input**: Design documents from `docs/specs/010-relationship-detection/`
...
- [x] T001 [P] Add relationship fixtures under `internal/testfixtures/relationship-detection/`, including a map fixture repository with `go.mod`, `go.sum`, `cmd/example/main.go`, and `internal/worker/worker.go`, plus a selection fixture that preserves claim-only and unknown relationship examples.
...
- [x] T018 Update `docs/product-backlog.md` and `docs/specs/010-relationship-detection/spec.md` status after implementation.
- [x] T019 Record pre-implementation review disposition under `docs/specs/010-relationship-detection/reviews/`.
- [x] T020 Record post-slice review disposition under `docs/specs/010-relationship-detection/reviews/`.
- [x] T021 Run `go test -count=1 ./...`.
- [x] T022 Run `jq empty schema/*.json internal/testfixtures/corpus-manifests/apache-bigtop/manifest.json`.
- [x] T023 Run `go run ./cmd/portolan map --root internal/testfixtures/relationship-detection/repo --out /tmp/portolan-relationships-run --force`.
