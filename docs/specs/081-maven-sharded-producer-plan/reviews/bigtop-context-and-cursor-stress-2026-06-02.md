...
go run ./cmd/portolan context prepare \
  ...
  --out /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-081-maven-sharded-producer-plan/context \
  --profile cursor \
  --force
```
...
- Context pack was written under:
  `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-081-maven-sharded-producer-plan/context`
...
- Every Maven command writes under:
  `/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-081-maven-sharded-producer-plan/context/tool-outputs/maven-cyclonedx/`
