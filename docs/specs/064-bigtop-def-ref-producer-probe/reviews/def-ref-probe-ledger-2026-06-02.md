...
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260602-064-def-ref-producer-probe/tool-outputs`
...
gopls	found	/home/governor/.local/bin/gopls
...
- `/home/governor/projects/bigtop-landscape/repos/apache-hadoop`
- `/home/governor/projects/bigtop-landscape/repos/apache-hbase`
- `/home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo`

The only jar found in selected scope:

```text
/home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo/bigtop-tests/test-artifacts/hadoop/src/main/resources/cachedir.jar
```
