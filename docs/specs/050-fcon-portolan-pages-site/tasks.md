...
**Input**: Design documents from `docs/specs/050-fcon-portolan-pages-site/`
...
- [x] T001 Create SpecKit artifacts in `docs/specs/050-fcon-portolan-pages-site/spec.md`
- [x] T002 Record site options in `docs/specs/050-fcon-portolan-pages-site/reviews/site-options-2026-05-30.md`
- [x] T003 Record site repository decision in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-topology-decision-2026-05-31.md`
- [x] T004 Record default Pages URL versus custom domain policy in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-domain-decision-2026-05-31.md`
- [x] T005 Record GitHub Actions publishing decision in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-publishing-decision-2026-05-31.md`
- [x] T006 Record first-screen copy and visual direction approval in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-copy-direction-2026-05-31.md`
- [x] T006A Verify 047 install/release and 049 demo routes exist before drafting Portolan page links; record in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-dependency-check-2026-05-31.md`
...
- [x] T014 [US1] Record first-screen review in `docs/specs/050-fcon-portolan-pages-site/reviews/fcon-entry-review-2026-05-31.md`
...
- [x] T020 [US2] Record site claim scan in `docs/specs/050-fcon-portolan-pages-site/reviews/portolan-page-claim-scan-2026-05-31.md`
...
- [x] T022 [US3] Record domain, DNS, and HTTPS state in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-domain-closeout-2026-05-31.md`
- [x] T023 [US3] Record third-party script/form/analytics scan in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-risk-scan-2026-05-31.md`
- [x] T024 [US3] Record local preview or deployment smoke in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-preview-closeout-2026-05-31.md`
...
- [x] T025 Run product-claim scan over `docs/site/`, `README.md`, and `docs/product-claims.md`; record result in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T026 Run third-party risk scan over `docs/site/` and `.github/workflows/`; record result in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T027 Run local static preview or record blocker in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T028 Run `git diff --check` and record result in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T029 Run baseline `go test -count=1 ./...` as a repository guard even though the feature is static-site only; record result in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T030 Run baseline `jq empty schema/*.json` as a repository guard; record result in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T031 Record Pages deployment and domain evidence in `docs/specs/050-fcon-portolan-pages-site/reviews/pages-closeout-2026-05-31.md`
- [x] T032 Update `docs/specs/050-fcon-portolan-pages-site/spec.md` status
- [x] T033 Update `docs/specs/050-fcon-portolan-pages-site/tasks.md` completion ledger
