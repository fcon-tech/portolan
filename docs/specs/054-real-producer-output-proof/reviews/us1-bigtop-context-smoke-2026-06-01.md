...
```text
/home/governor/projects/bigtop-landscape/.portolan/producer-runs.jsonl
```

Referenced local outputs:

```text
/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/tool-outputs/apache-bigtop-compose.config.json
/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/tool-outputs/alluxio-monitor.helm-template.yaml
/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/tool-outputs/alluxio-grpc.descriptor.pb
```
...
```bash
go run ./cmd/portolan context prepare --root /home/governor/projects/bigtop-landscape --out /home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/context --profile cursor --force
```
