...
```text
/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/cursor/cursor-composer25-producer-runs-prompt.md
```

Raw output:

```text
/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/cursor/cursor-composer25-producer-runs-output.md
```

Command:

```bash
timeout 10m zsh -lc 'cursor-agent --print --mode ask --model composer-2.5 --trust --workspace /home/governor/projects/bigtop-landscape "$(cat /home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/cursor/cursor-composer25-producer-runs-prompt.md)" | tee /home/governor/projects/bigtop-landscape/.portolan/stress/20260601-054-initial-proof/cursor/cursor-composer25-producer-runs-output.md'
```
...
```text
/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-190628/cursor-composer25-post-merge-output.md
```
