...
**Input**: Design documents from `docs/specs/048-github-community-discovery/`
...
- [x] T001 Create SpecKit artifacts in `docs/specs/048-github-community-discovery/spec.md`
- [x] T002 Record package self-review in `docs/specs/048-github-community-discovery/reviews/spec-package-self-review-2026-05-30.md`
- [x] T003 Record approved GitHub private vulnerability reporting path in `docs/specs/048-github-community-discovery/reviews/security-contact-options-2026-05-30.md`
- [x] T004 Decide fallback alias policy in `docs/specs/048-github-community-discovery/reviews/security-contact-options-2026-05-30.md`
- [x] T005 Record repository description, topic set, and Pages homepage proposal in `docs/specs/048-github-community-discovery/reviews/github-metadata-proposal-2026-05-30.md`
- [x] T006 Record conduct policy choice in `docs/specs/048-github-community-discovery/reviews/conduct-policy-decision-2026-05-30.md`
- [x] T007 Record GitHub private vulnerability reporting setting state in `docs/specs/048-github-community-discovery/reviews/github-security-settings-2026-05-30.md`
...
- [x] T017 [US1] Add GitHub metadata application instructions to `docs/specs/048-github-community-discovery/reviews/github-metadata-proposal-2026-05-30.md`
- [x] T018 [US1] Record applied GitHub description/topics/homepage state in `docs/specs/048-github-community-discovery/reviews/github-metadata-closeout-2026-05-30.md`
...
- [x] T022 [US2] Record template dry-run review in `docs/specs/048-github-community-discovery/reviews/community-template-dry-run-2026-05-30.md`
...
- [x] T026 [US3] Record security wording review against `docs/product-claims.md` in `docs/specs/048-github-community-discovery/reviews/security-claim-review-2026-05-30.md`
...
- [x] T027 Run `git diff --check` and record result in `docs/specs/048-github-community-discovery/reviews/community-closeout-2026-05-30.md`
- [x] T028 Run `go test -count=1 ./...` and record result in `docs/specs/048-github-community-discovery/reviews/community-closeout-2026-05-30.md`
- [x] T029 Run `jq empty .specify/feature.json schema/*.json` and record result in `docs/specs/048-github-community-discovery/reviews/community-closeout-2026-05-30.md`
- [x] T030 Run public-claim wording scan over `README.md`, `CONTRIBUTING.md`, `SECURITY.md`, `SUPPORT.md`, `.github/`, and record result in `docs/specs/048-github-community-discovery/reviews/community-closeout-2026-05-30.md`
- [x] T031 Record current GitHub metadata, badge, Scorecard, and community profile states, including `blocked` and `not_assessed`, in `docs/specs/048-github-community-discovery/reviews/github-metadata-closeout-2026-05-30.md`
- [x] T032 Update `docs/specs/048-github-community-discovery/spec.md` status
- [x] T033 Update `docs/specs/048-github-community-discovery/tasks.md` completion ledger
