...
git grep -n -E 'AKIA[0-9A-Z]{16}|BEGIN (RSA|DSA|EC|OPENSSH|PRIVATE) KEY|ghp_[A-Za-z0-9_]{36,}|github_pat_[A-Za-z0-9_]+|password\s*=|passwd\s*=|secret\s*=|api[_-]?key\s*=' -- . ':!docs/specs/**/reviews/*.md' ':!docs/**'
```
