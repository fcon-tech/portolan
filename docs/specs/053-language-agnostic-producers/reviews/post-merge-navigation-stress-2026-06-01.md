...
Root `/home/governor/projects/bigtop-landscape/run` was absent before and
after the corrected runs.

## Verified Artifacts

Guidance-corrected run directory:
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-191803/`

Navigation-index run directory:
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-194753/`
...
Final output:
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-191803/cursor-composer25-final-after-sbom-count-output.md`

Navigation-index output:
`/home/governor/projects/bigtop-landscape/.portolan/stress/20260601-194753/cursor-composer25-navigation-index-output.md`
...
- The navigation-index Cursor output contains no old run IDs, no root
  `/home/governor/projects/bigtop-landscape/run` usage, no
