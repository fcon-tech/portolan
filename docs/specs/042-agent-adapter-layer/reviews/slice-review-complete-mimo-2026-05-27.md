...
not_assessed:
- No runtime execution or fixture consistency check is present in this diff beyond tests referencing internal/testfixtures/oss-adapter-contract/graphify-minimal.json.
