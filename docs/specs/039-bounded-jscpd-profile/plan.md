...
**Spec**: `docs/specs/039-bounded-jscpd-profile/spec.md`

**Input**: Feature specification from
`docs/specs/039-bounded-jscpd-profile/spec.md`
...
```text
docs/specs/039-bounded-jscpd-profile/
├── checklists/
│   └── requirements.md
├── contracts/
...
internal/testfixtures/                     # Small fixtures for bounded producer/import behavior
