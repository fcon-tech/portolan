...
Date: 2026-05-27
Spec: `docs/specs/044-runtime-security-boundary/`
...
| Runtime selection validation | verified | `go run ./cmd/portolan selection validate --selection internal/app/testfixtures/runtime-security-boundary/selection.json` passed. |
| Runtime scan smoke | verified | `go run ./cmd/portolan scan --selection internal/app/testfixtures/runtime-security-boundary/selection.json --out /tmp/portolan-044-runtime-graph.json --force` wrote a graph. |
| Runtime map smoke | verified | `go run ./cmd/portolan map --selection internal/app/testfixtures/runtime-security-boundary/selection.json --out /tmp/portolan-044-runtime-map --force` wrote a map bundle. |
