...
```bash
protoc --decode_raw < /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-057-producer-expansion/tool-outputs/alluxio-all-protos.descriptor.pb >/dev/null
jq empty /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-057-producer-expansion/tool-outputs/jscpd-bigtop-tests/jscpd-report.json
awk 'BEGIN{bad=0} NF != 3 {bad=1; print "bad line", NR, $0} END{exit bad}' /home/governor/projects/bigtop-landscape/.portolan/stress/20260602-057-producer-expansion/tool-outputs/gopls-airflow-go-sdk-selected-status.tsv
find /home/governor/projects/bigtop-landscape/repos/apache-bigtop-repo \( -name '*semgrep*' -o -name '.semgrep*' \) -print
```
