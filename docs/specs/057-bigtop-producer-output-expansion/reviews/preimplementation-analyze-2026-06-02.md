...
| --- | --- | --- | --- |
| A1 | high | Runtime topology remains unavailable: `/home/governor/projects/bigtop-landscape/selection.json` has `runtime: null`, and running Docker containers are unrelated to Bigtop. | Keep runtime blocked/not_assessed. |
