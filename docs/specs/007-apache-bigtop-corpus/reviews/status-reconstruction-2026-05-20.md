...
| Spec status | verified | `docs/specs/007-apache-bigtop-corpus/spec.md` says `Ready for acceptance-smoke planning`. |
| Plan | verified | `docs/specs/007-apache-bigtop-corpus/plan.md` scopes 007 as documentation and data, with no scanner implementation. |
...
The nearest ready work is Phase 5 of `docs/specs/007-apache-bigtop-corpus/`, not
`docs/specs/009-map-command-artifacts/`. Spec 009 is prepared but explicitly gated
by the Bigtop smoke.
