...
Date: 2026-05-27
Spec: `docs/specs/007-apache-bigtop-corpus/`
Lane: Cursor Agent CLI / Composer 2.5
Target: `/home/governor/projects/bigtop-landscape`
...
```text
PORTOLAN_PATH=/home/governor/projects/sdp/portolan
TARGET_PATH=/home/governor/projects/bigtop-landscape
...
```bash
cursor-agent --print --trust --force --model composer-2.5 --output-format text --workspace /home/governor/projects/sdp/portolan "$PROMPT"
```
...
```bash
portolan context prepare --root /home/governor/projects/bigtop-landscape --out /tmp/portolan-cursor-composer25-bigtop-20260527222530/agent-output/context --profile cursor
portolan map --root /home/governor/projects/bigtop-landscape --out /tmp/portolan-cursor-composer25-bigtop-20260527222530/agent-output/map
```
