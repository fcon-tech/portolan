...
```text
/home/governor/projects/bigtop-landscape/.portolan/stress/<timestamp>-076-cursor-enterprise-parity/
```
...
```bash
go run ./cmd/portolan context prepare --root /home/governor/projects/bigtop-landscape --out /home/governor/projects/bigtop-landscape/.portolan/stress/<timestamp>-076-cursor-enterprise-parity/context --profile agent --force
go run ./cmd/portolan map --selection /home/governor/projects/bigtop-landscape/selection.json --out /home/governor/projects/bigtop-landscape/.portolan/stress/<timestamp>-076-cursor-enterprise-parity/map-selection --force
go run ./cmd/portolan map --root /home/governor/projects/bigtop-landscape --out /home/governor/projects/bigtop-landscape/.portolan/stress/<timestamp>-076-cursor-enterprise-parity/map-root --force
```
