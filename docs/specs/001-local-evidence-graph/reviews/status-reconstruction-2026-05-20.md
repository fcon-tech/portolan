...
ledger checkmarks, and review dispositions for `docs/specs/001-local-evidence-graph/`.
...
- `git log --oneline --decorate --max-count=12` showed
  ...
  `origin/main`.
- `docs/specs/001-local-evidence-graph/tasks.md` had all listed tasks checked.
- `internal/app/`, `internal/selection/`, `internal/graph/`, and
  `internal/scan/` contained the implemented scan path.
- `docs/specs/001-local-evidence-graph/reviews/slice1-review-disposition.md`
