...
git diff --check
go run ./cmd/portolan map --root /home/governor/projects/bigtop-landscape --out /tmp/portolan-024-bigtop-summary --force
jq empty /tmp/portolan-024-bigtop-summary/summary.json
go run ./cmd/portolan map --root /home/governor/projects/consensus_tg_bot --out /tmp/portolan-024-control-summary --force
```
