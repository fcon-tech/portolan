...
`docs/specs/037-relationship-evidence-taxonomy/`
...
- [x] T001 Create `docs/specs/037-relationship-evidence-taxonomy/reviews/`.
- [x] T002 [P] Record current relationship/evidence surfaces in `docs/specs/037-relationship-evidence-taxonomy/reviews/status-reconstruction-2026-05-27.md`.
- [x] T003 [P] Record requirements/product-vision drift review in `docs/specs/037-relationship-evidence-taxonomy/reviews/requirements-product-vision-drift-2026-05-27.md`.
...
- [x] T004 [P] Review `docs/specs/037-relationship-evidence-taxonomy/contracts/relationship-taxonomy.md` against `docs/evidence-model.md` and `docs/relationship-detection.md`.
...
- [x] T009 [US1] Run the focused generated-contract test and record results in `docs/specs/037-relationship-evidence-taxonomy/reviews/verification-2026-05-27.md`.
...
- [x] T010 [P] Run `go test ./...`, `jq empty schema/*.json`, and `git diff --check`, then record results in `docs/specs/037-relationship-evidence-taxonomy/reviews/verification-2026-05-27.md`.
- [x] T011 Create slice review disposition in `docs/specs/037-relationship-evidence-taxonomy/reviews/slice-review-disposition-2026-05-27.md`.
- [x] T012 Update `docs/specs/037-relationship-evidence-taxonomy/spec.md`, `docs/specs/037-relationship-evidence-taxonomy/tasks.md`, and `docs/product-backlog.md` so status and task state agree.
