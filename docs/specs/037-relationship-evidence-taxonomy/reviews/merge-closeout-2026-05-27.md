...
- Remote feature branch cleanup: requested by merge command; local branch was
  ...
  `/home/governor/projects/sdp/portolan-037-relationship-evidence-taxonomy`
...
- `docs/specs/037-relationship-evidence-taxonomy/spec.md`: updated to "Implemented
  and merged via PR #17; GitHub checks not_assessed".
- `docs/specs/037-relationship-evidence-taxonomy/tasks.md`: all implementation
