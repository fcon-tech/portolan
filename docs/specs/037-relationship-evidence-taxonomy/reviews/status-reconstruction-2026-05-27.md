...
- Backlog row: `docs/product-backlog.md` lists
  `docs/specs/037-relationship-evidence-taxonomy/` as `Specified`.
- Spec status: `docs/specs/037-relationship-evidence-taxonomy/spec.md` was `Draft`
...
`docs/specs/034-cursor-comparison-validation/` from the stale `AGENTS.md` plan
