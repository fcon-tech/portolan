...
ecosystem root without using `/home/governor/projects/bigtop-landscape/selection.json`.
...
```bash
go run ./cmd/portolan context prepare --root /home/governor/projects/bigtop-landscape --out /tmp/portolan-bigtop-context --profile cursor --force
```
