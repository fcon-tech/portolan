...
- Local target root: `/home/governor/projects/vibe_coding`
...
Initial `portolan map --root /home/governor/projects/vibe_coding` failed:
...
`docs/specs/028-large-findings-jsonl/` replaces scanner-based findings reading with
...
```bash
.portolan/bin/portolan context prepare --root /home/governor/projects/vibe_coding --out /tmp/portolan-vibecoding-context-028 --profile cursor --force
.portolan/bin/portolan map --root /home/governor/projects/vibe_coding --out /tmp/portolan-vibecoding-map-028 --force
```
