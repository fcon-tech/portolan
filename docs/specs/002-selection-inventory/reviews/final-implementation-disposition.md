...
All tasks in `docs/specs/002-selection-inventory/tasks.md` are complete:
...
- `docs/specs/002-selection-inventory/spec.md`: status is `Implemented in branch`.
- `docs/specs/002-selection-inventory/tasks.md`: all tasks are checked.
- Review artifacts are under `docs/specs/002-selection-inventory/reviews/`.
- Implementation files are in `internal/app/`, `internal/selection/`, `schema/`,
  and `internal/testfixtures/`.
...
go run ./cmd/portolan selection validate --selection internal/testfixtures/selection-inventory/valid-selection.json
go run ./cmd/portolan scan --selection internal/testfixtures/local-evidence-graph/selection.json --out /tmp/portolan-graph.json --force
