...
**Input**: Design documents from `docs/specs/002-selection-inventory/`
...
- [x] T001 [P] Add selection inventory fixtures in `internal/testfixtures/selection-inventory/valid-selection.json`, `internal/testfixtures/selection-inventory/duplicate-ids.json`, `internal/testfixtures/selection-inventory/network-url.json`, and `internal/testfixtures/selection-inventory/missing-path.json`.
...
- [x] T006 [P] [US2] Add a regression test proving `portolan scan --selection internal/testfixtures/local-evidence-graph/selection.json --out <file>` still succeeds in `internal/app/app_test.go`.
...
- [x] T014 Record pre-implementation review disposition under `docs/specs/002-selection-inventory/reviews/`.
- [x] T015 Run `go test -count=1 ./...`.
- [x] T016 Run `jq empty schema/*.json`.
- [x] T017 Run `go run ./cmd/portolan selection validate --selection internal/testfixtures/selection-inventory/valid-selection.json`.
- [x] T018 Run `go run ./cmd/portolan scan --selection internal/testfixtures/local-evidence-graph/selection.json --out /tmp/portolan-graph.json --force`.
