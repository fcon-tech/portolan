  ...
  "targets": [
    {
      "id": "repo-main",
      "kind": "repository",
      "path": "internal/testfixtures/selection-inventory/repo"
    }
  ],
  "metadata": [
    {
      "id": "service-metadata",
      "path": "internal/testfixtures/selection-inventory/service-catalog.json"
    }
  ],
  "runtime": [
    {
      "id": "runtime-export",
      "path": "internal/testfixtures/selection-inventory/runtime.json"
    }
  ],
  "claims": [
    {
      "id": "claims-main",
      "path": "internal/testfixtures/selection-inventory/claims.json"
    }
  ]
}
```
