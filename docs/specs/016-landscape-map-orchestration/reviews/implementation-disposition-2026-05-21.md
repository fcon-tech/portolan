...
- Blocking Edge Cases: Full Bigtop acceptance requires every active/external
  ...
  were prepared under `/Users/governor/projects/faust/sdp/bigtop-landscape/repos`
...
- verified: `go run ./cmd/removed Bigtop-specific selection generator --manifest internal/testfixtures/corpus-manifests/apache-bigtop/manifest.json --repo-dir /Users/governor/projects/faust/sdp/bigtop-landscape/repos --out /Users/governor/projects/faust/sdp/bigtop-landscape/selection.json --force`
- verified: `go run ./cmd/portolan map --selection /Users/governor/projects/faust/sdp/bigtop-landscape/selection.json --out /Users/governor/projects/faust/sdp/bigtop-landscape/run --force`
- verified: `/Users/governor/projects/faust/sdp/bigtop-landscape/run/coverage.json` has `blocked: []`, 15 selected local repository records, and no non-source inventory blockers.
- verified: `/Users/governor/projects/faust/sdp/bigtop-landscape/run/` contains `run.json`, `coverage.json`, `graph.json`, `findings.jsonl`, and `map.md`.
