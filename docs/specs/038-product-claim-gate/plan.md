...
**Spec**: `docs/specs/038-product-claim-gate/spec.md`
...
`docs/specs/034-cursor-comparison-validation/`, `docs/specs/035-oss-producer-acceptance/`,
`docs/specs/036-scope-completeness-validation/`, and
`docs/specs/037-relationship-evidence-taxonomy/`.

**Storage**: Spec-local files under `docs/specs/038-product-claim-gate/`; no runtime
...
```text
docs/specs/038-product-claim-gate/
|-- plan.md
|-- research.md
|-- data-model.md
|-- quickstart.md
...
docs/specs/035-oss-producer-acceptance/
