...
| Lane | State | Notes |
| --- | --- | --- |
| `kimi-coding/kimi-for-coding` | assessed | Conditional pass. Required Phase 2 source/privacy artifacts, exact CLI syntax verification, Bigtop license note, T016/T027 smoke split, and `docs/test-corpora/apache-bigtop/examples/` path policy. |
...
| `docs/test-corpora/apache-bigtop/examples/README.md` versus `docs/test-corpora/apache-bigtop/examples/README.md` ambiguity | Fixed in plan and tasks. The top-level README is redaction policy; nested README is artifact index/freshness. |
