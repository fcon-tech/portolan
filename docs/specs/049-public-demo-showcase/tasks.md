...
**Input**: Design documents from `docs/specs/049-public-demo-showcase/`
...
- [x] T001 Create SpecKit artifacts in `docs/specs/049-public-demo-showcase/spec.md`
- [x] T002 Record package self-review in `docs/specs/049-public-demo-showcase/reviews/spec-package-self-review-2026-05-30.md`
- [x] T003 Record Apache Bigtop demo target in `docs/specs/049-public-demo-showcase/reviews/demo-artifact-policy-2026-05-30.md`
- [x] T004 Record approved runbook plus redacted excerpts policy in `docs/specs/049-public-demo-showcase/reviews/demo-artifact-policy-2026-05-30.md`
- [x] T005 Defer full generated Bigtop outputs, screenshots, and recordings in `docs/specs/049-public-demo-showcase/reviews/demo-artifact-policy-2026-05-30.md`
...
- [x] T006 Record Apache Bigtop acquisition options, Apache 2.0 license note, rejected Portolan self-map rationale, and network/disk behavior in `docs/specs/049-public-demo-showcase/reviews/bigtop-demo-source-2026-05-30.md`
- [x] T007 Verify current `portolan context prepare`, `portolan map`, and bounded `portolan query` or `portolan graph slice` CLI forms; record the exact command evidence in `docs/specs/049-public-demo-showcase/reviews/bigtop-demo-source-2026-05-30.md`
...
- [x] T009 Add redaction rules for sample excerpts to top-level `docs/test-corpora/apache-bigtop/examples/README.md` and freshness/privacy review template to `docs/specs/049-public-demo-showcase/reviews/demo-privacy-freshness-template.md`
...
- [x] T016 [US1] Record first-attempt fresh demo smoke result, elapsed time, or blocker in `docs/specs/049-public-demo-showcase/reviews/bigtop-demo-smoke-2026-05-30.md`
...
- [x] T020 [US2] Record case-study claim scan in `docs/specs/049-public-demo-showcase/reviews/demo-claim-scan-2026-05-30.md`
...
- [x] T021 [US3] Add redacted `summary.json` excerpt to `docs/test-corpora/apache-bigtop/examples/summary-excerpt.json`
- [x] T022 [US3] Add redacted `map.md` excerpt to `docs/test-corpora/apache-bigtop/examples/map-excerpt.md`
- [x] T023 [US3] Add redacted `evidence-index.jsonl` excerpt to `docs/test-corpora/apache-bigtop/examples/evidence-index-excerpt.jsonl`
- [x] T024 [US3] Add redacted `answer-contract.md` excerpt to `docs/test-corpora/apache-bigtop/examples/answer-contract-excerpt.md`
- [x] T025 [US3] Add redacted bounded query/gaps excerpt or explain why the query is only documented, not committed, in `docs/test-corpora/apache-bigtop/examples/README.md`
- [x] T026 [US3] Add generation command and freshness notes to nested artifact index `docs/test-corpora/apache-bigtop/examples/README.md`
- [x] T027 [US3] Record private-path and secret scan in `docs/specs/049-public-demo-showcase/reviews/demo-privacy-freshness-2026-05-30.md`
...
- [x] T028 Run final Apache Bigtop demo smoke or record blocker in `docs/specs/049-public-demo-showcase/reviews/bigtop-demo-smoke-2026-05-30.md`
- [x] T029 Run `go test -count=1 ./...` and record result in `docs/specs/049-public-demo-showcase/reviews/demo-closeout-2026-05-30.md`
- [x] T030 Run `jq empty .specify/feature.json schema/*.json docs/test-corpora/apache-bigtop/examples/*.json` and record result in `docs/specs/049-public-demo-showcase/reviews/demo-closeout-2026-05-30.md`
- [x] T031 Run `git diff --check` and record result in `docs/specs/049-public-demo-showcase/reviews/demo-closeout-2026-05-30.md`
- [x] T032 After T019 and T026, run product-claim drift scan over `docs/demo.md`, `docs/test-corpora/apache-bigtop/examples/`, and `docs/product-claims.md`; record result in `docs/specs/049-public-demo-showcase/reviews/demo-closeout-2026-05-30.md`
- [x] T033 Update README demo link in `README.md`
- [x] T034 Update `docs/specs/049-public-demo-showcase/spec.md` status
- [x] T035 Update `docs/specs/049-public-demo-showcase/tasks.md` completion ledger
