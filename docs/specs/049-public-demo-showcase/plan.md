...
**Input**: Feature specification from `docs/specs/049-public-demo-showcase/spec.md`
...
`docs/test-corpora/apache-bigtop/examples/`; top-level redaction policy under
...
```text
docs/specs/049-public-demo-showcase/
|-- spec.md
|-- plan.md
|-- research.md
|-- data-model.md
...
**Structure Decision**: Prefer `docs/demo.md` plus optional `docs/test-corpora/apache-bigtop/examples`
