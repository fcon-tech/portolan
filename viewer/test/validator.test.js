/**
 * Unit tests for the system-map semantic validator.
 * Covers the Bundle Input Contract invariants that JSON Schema cannot express.
 *
 * RED phase: the validator currently lives in validate-system-map.js as a
 * script; these tests will drive extracting a reusable validate(map) function.
 */
'use strict';
...
const { validateSystemMap } = require('../scripts/system-map/validate');
