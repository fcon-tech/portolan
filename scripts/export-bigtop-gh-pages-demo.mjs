...
function sanitizeText(value) {
  ...
  return value
    .replaceAll('/home/governor/projects/bigtop-landscape/repos/', '')
    .replaceAll('/home/governor/projects/bigtop-landscape/', '')
    .replaceAll('/tmp/portolan-bigtop-20260623-full-proof/', '')
    .replaceAll('/tmp/', '')
    .replaceAll('/home/governor/', '');
}
...
const forbidden = ['/home/governor', '/tmp/', 'projects/bigtop-landscape'];
