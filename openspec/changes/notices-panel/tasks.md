...
- [ ] 1.1 Add `parseNotices` (grammar of `renderNotices`) to
...
- [ ] 2.1 Render the Notices panel in `template.html` (per-action styling,
      anchors list, honest empty state, engineering lexicon title) and
      verify: both modes show the section, empty state visible

## 3. Verify + archive

- [ ] 3.1 Regenerate the Bigtop artifact from core and extend the headless
