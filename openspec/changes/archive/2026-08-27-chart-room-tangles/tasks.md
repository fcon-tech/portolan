...
- [x] 1.1 Implement `findTangles` (Tarjan SCC, size ≥ 2, sorted members) in
...
- [x] 2.1 Render whirlpool marks at member centroids (nautical), the panel
...
- [x] 3.1 Full suite green (`bun test`, tsc), regenerate both real
