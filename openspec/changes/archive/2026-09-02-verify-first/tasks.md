...
- [x] 2.2 Whole-change review (code-reviewer against this proposal) plus the socratic pass (advisory). Verify: findings addressed or dissented in `design.md`; no silent drops.
