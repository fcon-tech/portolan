...
- [ ] 1.1 Create the skill content under `skill/` (one method document in
...
- [ ] 1.2 Add the Sailing Directions template (top findings with anchors +
...
- [ ] 2.1 Write the launch section (install skill + MCP server into the
...
- [ ] 2.2 Write the single-approval section (one message covering network
...
- [ ] 2.3 Write the perimeter section (writes only under
...
- [ ] 3.1 Write the five-pass method (vessels from manifests/entry points →
...
- [ ] 3.2 Write the interruption guidance (stop anywhere; what stands stays
      ...
      elsewhere
- [ ] 3.3 Write the honesty section (runtime topology, deployed versions,
...
- [ ] 4.1 Write the assert → sound → write-with-verdict loop (sound.edge
...
- [ ] 4.2 Write the later-expedition section (start from the Chart, repair
...
- [ ] 5.1 Write the closing step (deliver Sailing Directions in
...
- [ ] 5.2 Add the unanchored-claim rule to the template guidance (exclude
