/**
 * Domain: surface classification + state helpers.
 *
 ...
 * Surfaces attach to a unit (owner); they are never peer nodes on the behaviour
 * map (charter 08 ontology).
 *
 * Depends on family-lens.normalizeRole (inbound domain dependency — allowed).
 * Pure functions. Domain layer.
 */
'use strict';

const { normalizeRole } = require('./family-lens');
